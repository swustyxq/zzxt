			...
			success : function(msg) {
				if(msg.result == true){	
					...
					if(msg.workstepfolw==null){//判断是否已经申请 null未申请则执行
						readinfo(msg);
					}else if(msg.workstepfolw.wsflId==16){
						readinfo(msg);
					}else{
						//alert("shabi yangjunhui");
							alert("亲，您已经申请过了");
							changebutton();
							location.href("seeLzList.html");
					}
				}else{	
					alert(msg.message);
				}
...
var ob = document.getElementsByName("radio2");
	for(var i=0; i<ob.length; i ++){
	    if(ob[i].checked){
	    	if(i==1){
	    		document.getElementById("gjlzComprehensiveranking1").disabled=true;
	    		document.getElementById("gjlzComprehensiveranking1").placeholder="";
	    		document.getElementById("gjlzComprehensiveranking2").disabled=true;
	    		document.getElementById("gjlzComprehensiveranking2").placeholder="";
	    	}else{
	    		document.getElementById("gjlzComprehensiveranking1").disabled=false;
	    		document.getElementById("gjlzComprehensiveranking1").placeholder="请输入";
	    		document.getElementById("gjlzComprehensiveranking2").disabled=false;
	    		document.getElementById("gjlzComprehensiveranking2").placeholder="请输入";
	    	}
	    }
	}
}
...
var obj1 = document.getElementsByName("radio1");					
	...
	//alert(msg.studentInfo.stinResidence);
